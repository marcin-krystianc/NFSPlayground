...
#
# Usage: bash scripts/nfs-test-env/00-run-all-on-vm-and-docker.sh
#        bash scripts/nfs-test-env/00-run-all-on-vm-and-docker.sh generic/001 generic/002
#        bash scripts/nfs-test-env/00-run-all-on-vm-and-docker.sh -g quick
#
...
log "writing $config"
cat > "$config" <<EOF
# generated by 00-run-all-on-vm-and-docker.sh -- do not edit, it is overwritten
export FSTYP=nfs
