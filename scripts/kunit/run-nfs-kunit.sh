...
UNSTATIC=(
    ...
    "fs/nfs/pnfs.c:s64:pnfs_lseg_range_cmp"
    "fs/nfs/pnfs.c:bool:pnfs_lseg_range_is_after"
    "fs/nfs/pnfs.c:bool:pnfs_lseg_range_contained"
    "fs/nfs/pnfs.c:bool:pnfs_lseg_range_match"
    "fs/nfs/pnfs.c:bool:pnfs_should_free_range"
    "fs/nfs/pnfs.c:bool:pnfs_match_lseg_recall"
    "fs/nfs/pnfs.c:struct pnfs_layout_segment *:pnfs_find_lseg"
    "fs/nfs/pnfs.c:bool:pnfs_sanity_check_layout_range"
    "fs/nfs/pnfs.c:bool:pnfs_within_mdsthreshold"
    "fs/nfs/nfs4namespace.c:ssize_t:nfs4_pathname_len"
    "fs/nfs/nfs4namespace.c:char *:nfs4_pathname_string"
    "fs/nfs/nfs4namespace.c:char *:nfs_path_component"
    "fs/nfs/nfs4namespace.c:char *:nfs4_path"
    "fs/nfs/nfs4namespace.c:int:nfs4_validate_fspath"
...
for entry in "${TESTS[@]}"; do
    ...
    # in nfs_fixture.c and "The per-test-case thread" in docs/kunit-nfs-reference.md.
